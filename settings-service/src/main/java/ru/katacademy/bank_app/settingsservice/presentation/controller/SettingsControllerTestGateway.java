package ru.katacademy.bank_app.settingsservice.presentation.controller;
 ...
 *
 * Обрабатывает маршруты "/api/settings".
 * В рамках работы с использованием API Gateway.
 */
@RestController
@RequestMapping("/api/settings")
public class SettingsControllerTestGateway {
    ...
    public ResponseEntity<String> test() {
        return ResponseEntity.ok("Gateway до settings-service добрался");
    }
}
